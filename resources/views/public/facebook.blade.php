...
<section class="section section-cream"><div class="container text-center"><div class="mx-auto bg-white rounded shadow-sm p-2" style="max-width:540px;min-height:720px"><iframe src="{{$plugin}}" width="500" height="720" style="border:none;overflow:hidden;width:100%;max-width:500px" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share" title="Official Facebook page"></iframe></div><p class="mt-4"><a class="btn btn-primary" href="{{$facebook}}" target="_blank" rel="noopener">Open the official Facebook page</a></p></div></section>
@endsection
